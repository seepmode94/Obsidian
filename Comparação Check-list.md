...
- `Fichas de Aptidão` já não parece estar em falta; está mais detalhado.
- `Sessões` é um caso de conteúdo diferente entre ficheiros.
- `Medicina Ocupacional` continua a ser o módulo que mais precisa de revisão manual.
